...
const PackageCard: React.FC<PackageCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {(popular || bestValue) && (
        <div
          className={`${getBadgeStyle()} text-center py-2 font-medium text-sm flex items-center justify-center`}
        >
      ...
      <div className="bg-gray-900 p-6 border border-gray-700">
        <h3 className="text-xl font-display font-semibold mb-2 text-gray-200">
          {title}
        </h3>
