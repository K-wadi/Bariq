...
const BookingForm: React.FC = () => {
  ...
  const validateForm = async () => {
    ...
    if (!formData.carModel.trim())
      newErrors.carModel = "Automodel is verplicht";
    if (!formData.licensePlate.trim()) {
  ...
  if (isSubmitted) {
    return (
      <div className="bg-green-50 p-6 md:p-8 rounded-lg border border-green-200 text-center">
        ...
        <h3 className="text-xl md:text-2xl font-display font-semibold text-green-800 mb-2">
          Bedankt voor je boeking!
        </h3>
        <p className="text-green-700 mb-4">
          We hebben je aanvraag ontvangen en zullen zo snel mogelijk contact met
          je opnemen om je boeking te bevestigen. Je ontvangt ook een
  ...
  return (
    <div className="bg-gray-900 rounded-lg shadow-md overflow-hidden border border-gray-700">
      ...
      <form onSubmit={handleSubmit} className="p-4 md:p-6 lg:p-8">
        {/* Desktop Header */}
        <h2 className="hidden md:block text-2xl font-display font-semibold mb-6 text-gray-200">
          Maak een afspraak
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-3 border ${
                  errors.phone ? "border-red-500" : "border-charcoal-300"
                } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-base`}
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 p-3 border ${
                    errors.licensePlate
                      ? "border-red-500"
                      : "border-charcoal-300"
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 placeholder-charcoal-400 text-base uppercase`}
                ...
                >
                  <span className="hidden sm:inline">
                    {isLoadingVehicle ? "Laden..." : "Opzoeken"}
                  </span>
                </Button>
              </div>
              {errors.licensePlate && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-green-800">
                      {formatVehicleInfo(vehicleData).displayName}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-green-800 capitalize">
                      {formatVehicleInfo(vehicleData).color.toLowerCase()}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border ${
                    errors.carBrand ? "border-red-500" : "border-charcoal-300"
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-base`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border ${
                    errors.carModel ? "border-red-500" : "border-charcoal-300"
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-base`}
          ...
          <div className="grid grid-cols-1 gap-4 md:gap-6">
            ...
            <div>
              ...
              <DatePicker
                ...
                className={`w-full p-3 border ${
                  errors.date ? "border-red-500" : "border-charcoal-300"
                } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-base`}
                  ...
                  <span className="inline-flex items-center">
                    <span
                      className={`w-2 h-2 rounded-full mr-2 ${
                        selectedDateStats.availableSlots > 5
                          ? "bg-green-500"
                          : selectedDateStats.availableSlots > 2
                          ? "bg-yellow-500"
                          : "bg-red-500"
                      }`}
                    ></span>
                    {selectedDateStats.availableSlots} van{" "}
                    {selectedDateStats.totalSlots} tijdsloten beschikbaar
                  </span>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              <div className="md:hidden">
                <button
                  ...
                  className={`w-full p-3 border ${
                    errors.time ? "border-red-500" : "border-charcoal-300"
                  } rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 text-base text-left flex justify-between items-center ${
        ...
        <div className="bg-primary-50 p-4 rounded-md mb-6 flex items-start">
          ...
          <p className="text-primary-800 text-sm">
            Na het indienen van je aanvraag zullen we binnen 24 uur contact met
            je opnemen om je boeking te bevestigen. Je ontvangt ook direct een
            bevestigingsmail met alle details. Je kunt ook direct contact
            opnemen via WhatsApp voor snellere service.
          </p>
        </div>
