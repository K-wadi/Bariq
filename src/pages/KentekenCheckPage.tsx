        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl text-bariq-grey mb-8">
              Voer je kenteken in voor een nauwkeurige prijsindicatie op basis
              van je voertuiggegevens
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="mt-8 p-6 bg-bariq-black rounded-xl border border-gray-800 flex items-start gap-4">
              ...
              <div className="text-sm text-bariq-grey">
                ...
                <p>
                  ...
                  volgens de Rijksdienst voor het Wegverkeer. De indicatie die
                  je ontvangt is voor ons basispakket. Extra's kun je tijdens
                  het boeken toevoegen.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-bariq-white mb-2">
                  Klasse A
                </h3>
                <div className="text-5xl font-bold text-bariq-red mb-2">
                  €90
                </div>
                <p className="text-sm text-bariq-grey">
                  Basis pakket inbegrepen
                </p>
              </div>

              <div className="space-y-3 text-sm text-bariq-grey">
                <p className="font-semibold text-bariq-white mb-3">
                  Voorbeelden:
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-bariq-black p-8 md:p-12 rounded-2xl border border-bariq-red">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-bariq-white">
            ...
            <div className="mt-8 text-center">
              <p className="text-bariq-grey mb-6">
                Wil je extra's toevoegen zoals dieptereiniging van stoelen,
                hemel of plastic matteren?
              </p>
