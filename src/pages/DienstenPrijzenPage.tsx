...
const DienstenPrijzenPage: React.FC = () => {
  const baseDiensten = [
    {
      ...
      description:
        "Lakvriendelijke handmatige wassing met PH-neutrale shampoo. Streeploos, glanzend resultaat.",
    },
    {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto mb-8 md:mb-12">
            {baseDiensten.map((dienst, index) => (
              ...
              >
                <div className="text-bariq-red mb-3 md:mb-4">{dienst.icon}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto mb-12 md:mb-16">
            ...
            >
              <div className="text-center mb-6 md:mb-8">
                <h3 className="text-xl md:text-2xl font-bold text-bariq-white mb-3 md:mb-4">
                  Klasse A
                </h3>
                <div className="text-5xl md:text-6xl font-bold text-bariq-red mb-3 md:mb-4">
                  €90
                </div>
                <p className="text-sm md:text-base text-bariq-grey">
                  Compact & Midsize voertuigen
                </p>
              </div>
      ...
      <section
        id="extras"
        className="py-12 md:py-16 lg:py-24 bg-bariq-black-lighter"
      >
        <div className="container mx-auto px-4 md:px-6">
          <SectionTitle
